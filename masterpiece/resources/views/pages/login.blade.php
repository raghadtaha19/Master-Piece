...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('pages_assets/fonts/font-awesome-4.7.0/css/font-awesome.min.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('pages_assets/fonts/Linearicons-Free-v1.0.0/icon-font.min.css') }}">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('pages_assets/vendor/daterangepicker/daterangepicker.css') }}">
