        ...
        <div class="container">
            ...
            <div class="row services_row">
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    ...
                    <p class="para1">Thinking of selling your land? We streamline the process, handling the purchase on
                        your behalf.</p>
                </div>
                ...
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    ...
                    <p class="para1">Simply fill out our form with your land details to kickstart the selling process
                        effortlessly.</p>
                </div>
                ...
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    ...
                    <p class="para1">We believe in fair compensation. Our commission rates are clear, ensuring a mutually
                        beneficial arrangement.</p>
                </div>
                ...
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    ...
                    <p>Reserve your desired land effortlessly. Follow our simple process to secure your spot in the property
                        market.</p>
                </div>
                ...
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    ...
                    <p>Our dedicated team will reach out to you within five business days to arrange a meeting. Choose
                        between an in-person or virtual meeting based on your preference.</p>
                </div>
                ...
                <div class="col-lg-4 service_item text-left d-flex flex-column align-items-start justify-content-start">
                    ...
                    <p>Rest assured, we are here to assist you in any way possible. Your satisfaction is our priority, and
                        we are excited to connect with you soon!</p>
                </div>
            </div>
        </div>
