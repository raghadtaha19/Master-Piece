                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions">
                                                <div style="margin-bottom: 5px;">
                                                    <a class="btn btn-info btn-sm" href="{{ route('sellforms.edit', $sellform->id) }}" style="width: 100%;">
                                                        <i class="fas fa-pencil-alt"></i> Edit
                                                    </a>
                                                </div>
                                                <div style="margin-bottom: 5px;">
                                                    <form action="{{ route('sellforms.destroy', $sellform->id) }}" method="POST" style="display: inline;">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Sell Form?')" style="width: 100%;">
